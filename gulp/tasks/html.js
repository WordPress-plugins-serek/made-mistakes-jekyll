...
gulp.task('styles:critical:archive', () => {
  return gulp.src(paths.tempDir  + paths.siteDir + 'tag/index.html')
    .pipe(critical({
      base: paths.tempDir,
      inline: false,
...
gulp.task('styles:critical:post', () => {
  return gulp.src(
	paths.tempDir  + paths.siteDir + 'code/index.html', 
	paths.tempDir  + paths.siteDir + 'projects/index.html',
	paths.tempDir  + paths.siteDir + 'reviews/index.html')
    .pipe(critical({
      base: paths.tempDir,
      inline: false,
      css: [paths.sassFilesTemp + '/main.css'],
